...
//  dataStructure
//
//  Created by Ellison, Cy on 2/21/19.
...
Type CircularList<Type> :: remove(int index)
{
    ...
    DoubleNode<Type> * removePrevious = removed->getPrevious();
...
Type CircularList<Type> :: setAtIndex(int index, Type item)
{
    ...
    Double<Type> * replaceValue = findNode(index);
...
template <class Type>
int CircularList<Type> :: setSize() const
{
    return this-size;
}
